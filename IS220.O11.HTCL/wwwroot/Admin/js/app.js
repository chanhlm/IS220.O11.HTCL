    ...
    (t.prototype.openLeftBar = function () {
        e("#wrapper").toggleClass("enlarged"),
            ...
            e("#wrapper").hasClass("enlarged") && e("body").hasClass("fixed-left")
                ...
                e("body").hasClass("fixed-left-void") &&
                e("body").removeClass("fixed-left-void").addClass("fixed-left"),
            e("#wrapper").hasClass("enlarged")
                ? e(".left ul").removeAttr("style")
                : e(".subdrop").siblings("ul:first").show(),
            ...
            e("#wrapper").hasClass("enlarged") ||
                (e(this).parent().hasClass("has_sub") && t.preventDefault(),
                    e(this).hasClass("subdrop")
                        ? e(this).hasClass("subdrop") &&
                        (e(this).removeClass("subdrop"),
                            e(this).next("ul").slideUp(350),
                            e(".float-right i", e(this).parent())
                                .removeClass("mdi-minus")
                                .addClass("mdi-plus"))
                        : (e("ul", e(this).parents("ul:first")).slideUp(350),
                            e("a", e(this).parents("ul:first")).removeClass("subdrop"),
                            e("#sidebar-menu .float-right i")
                                .removeClass("mdi-minus")
                                .addClass("mdi-plus"),
                            e(this).next("ul").slideDown(350),
                            e(this).addClass("subdrop"),
                            e(".float-right i", e(this).parents(".has_sub:last"))
                                .removeClass("mdi-plus")
                                .addClass("mdi-minus"),
                            e(".float-right i", e(this).siblings("ul"))
                                .removeClass("mdi-minus")
                                .addClass("mdi-plus")));
        }),
        (t.prototype.init = function () {
            ...
            e(".open-left").click(function (e) {
                ...
                e("#sidebar-menu ul li.has_sub a.active")
                    .parents("li:last")
                    .children("a:first")
                    .addClass("active")
                    .trigger("click");
        ...
        (t.prototype.initTooltipPlugin = function () {
            ...
            (t.prototype.init = function () {
                this.initTooltipPlugin(),
                    ...
                    e(document).ready(this.onDocReady),
                    e.Portlet.init(),
                    e.Sidemenu.init(),
                    e.FullScreen.init();
            }),
...
function executeFunctionByName(e, t) {
    for (
        var i = [].slice.call(arguments).splice(2),
        s = e.split("."),
        n = s.pop(),
        l = 0;
        l < s.length;
...
function toggle_slimscroll(e) {
    $("#wrapper").hasClass("enlarged")
        ? ($(e).css("overflow", "inherit").parent().css("overflow", "inherit"),
            $(e).siblings(".slimScrollBar").css("visibility", "hidden"))
        : ($(e).css("overflow", "hidden").parent().css("overflow", "hidden"),
            $(e).siblings(".slimScrollBar").css("visibility", "visible"));
}
var wow = new WOW({
    boxClass: "wow",
...
//        if (
//            (17 == e.which && (isCtrl = !0),
//                85 == e.which || (67 == e.which && 1 == isCtrl))
//        )
//            return !1;
//    });
